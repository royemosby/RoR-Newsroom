...
RSpec.describe ArticleUpdate, type: :model do
  describe "CREATION" do
    ...
    it "must contain content" do
      @empty_update = ArticleUpdate.create(updater: @updater, article: @article1)
      @good_update = ArticleUpdate.create(updater: @updater, article: @article2, content: "This is an update")
      expect(@empty_update.valid?).to be false
      expect(@good_update.valid?).to be true
    end
  end
end
